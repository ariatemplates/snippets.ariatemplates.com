...
:{$type:"Object",$description:"",$properties:{color:{$type:"Color"}}},DatePickerCfg:{$type:"DropDownTextInputCfg",$description:"",$properties:{calendar:{$type:"Object",$properties:{showWeekNumbers:{$type:"json:Boolean",$description:"",$default:!0},restrainedNavigation:{$type:"json:Boolean",$description:"",$default:!0},showShortcuts:{$type:"json:Boolean",$description:"",$default:!0},numberOfUnits:{$type:"json:Integer",$description:"",$default:3},sclass:{$type:"json:String",$description:"sclass of the calendar to use inside the DatePicker. It must be defined in the skin."
,$default:"dropdown"}}}}},SelectBoxCfg:{$type:"DropDownTextInputCfg",$description:"",$properties:{listSclass:{$type:"json:String",$description:"sclass of the List to use inside the widget. It must be defined in the skin.",$default:"dropdown"}}},TextareaCfg:{$type:"TextInputCfg",$description:""},ErrorListCfg:{$type:"Object",$description:"",$properties:{divsclass:{$type:"json:String",$description:"sclass of the Div to use inside the widget. It must be defined in the skin."}}},FieldsetCfg:{$type:"Object",$description
:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"FieldsetStateCfg"}}},frame:{$type:"Frame"}}},FieldsetStateCfg:{$type:"StateWithFrame",$description:"",$properties:{label:{$type:"Object",$description:"",$properties:{left:{$type:"Pixels",$default:0},top:{$type:"Pixels",$default:0},paddingTop:{$type:"Pixels",$default:0},paddingLeft:{$type:"Pixels",$default:0},paddingRight:{$type:"Pixels",$default:0},paddingBottom:{$type:"Pixels",$default:0},backgroundColor:{$type:"Color",$default:"white"},
fontWeight:{$type:"json:String",$description:"",$default:"bold"},color:{$type:"Color",$default:"black"}}}}},MultiSelectCfg:{$type:"DropDownTextInputCfg",$description:"",$properties:{listSclass:{$type:"json:String",$description:"sclass of the List to use inside the widget. It must be defined in the skin.",$default:"dropdown"}}},SelectCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"StateWithFrameWithIcons"},normalFocused:{$type:"StateWithFrameWithIcons"},mandatory
:{$type:"StateWithFrameWithIcons"},mandatoryFocused:{$type:"StateWithFrameWithIcons"},disabled:{$type:"StateWithFrameWithIcons"},readOnly:{$type:"StateWithFrameWithIcons"},normalError:{$type:"StateWithFrameWithIcons"},normalErrorFocused:{$type:"StateWithFrameWithIcons"},mandatoryError:{$type:"StateWithFrameWithIcons"},mandatoryErrorFocused:{$type:"StateWithFrameWithIcons"}}},frame:{$type:"Frame"},iconsLeft:{$type:"IconsLeft"},iconsRight:{$type:"IconsRight"},simpleHTML:{$type:"json:Boolean",$description:'true when the widget has to have a basic markup as close as possible to standard HTML. As a consequence, a frame of type "SimpleHTML" will be used, which basically means that no further frame markup will be added.'
,$default:!1},offsetTop:{$type:"Pixels"},listSclass:{$type:"json:String",$description:"sclass of the List to use inside the widget. It must be defined in the skin.",$default:"dropdown"}}},SortIndicatorCfg:{$type:"Object",$description:"",$properties:{iconset:{$type:"json:String",$description:""},iconprefix:{$type:"json:String",$description:""}}},SplitterCfg:{$type:"Object",$description:"",$properties:{separatorHeight:{$type:"Pixels"},separatorWidth:{$type:"Pixels"},handleBackgroundColor:{$type:"Color",$default
:"transparent"},handleSpriteURLh:{$type:"json:String",$description:""},handleSpriteURLv:{$type:"json:String",$description:""},proxyBackgroundColor:{$type:"Color",$default:"transparent"},proxySpriteURLh:{$type:"json:String",$description:""},proxySpriteURLv:{$type:"json:String",$description:""},borderColor:{$type:"Color"}}},IconCfg:{$type:"Object",$description:"Description of a group of icons.",$properties:{iconWidth:{$type:"Pixels"},iconHeight:{$type:"Pixels"},spriteSpacing:{$type:"Pixels"},biDimensional:{$type
:"json:Boolean",$description:"",$default:!1},direction:{$type:"json:Enum",$description:"Whether the sprite is horizontal or vertical",$enumValues:["x","y"]},content:{$type:"json:Map",$default:{},$description:"",$contentType:{$type:"json:Integer",$description:"Index of the icon inside the sprite."},$keyType:{$type:"json:String",$description:'Name of the icon within this sprite. To be used to refer to a specific icon with the syntax "group:icon".'}},spriteURL:{$type:"json:String",$description:""}}},DivCfg:{$type
:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"StateWithFrame"},topLeft:{$type:"StateWithFrame"},bottomRight:{$type:"StateWithFrame"},bottomLeft:{$type:"StateWithFrame"}}},frame:{$type:"Frame"}}},DialogCfg:{$type:"Object",$description:"",$properties:{titleBarTop:{$type:"Pixels"},titleBarLeft:{$type:"Pixels"},titleBarRight:{$type:"Pixels"},titleBarHeight:{$type:"Pixels"},titleColor:{$type:"Color",$default:"#615E55"},divsclass:{$type:"json:String",$description:"sclass of the Div to use inside the widget. It must be defined in the skin."
},closeIcon:{$type:"json:String",$description:""}}},TextInputCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"TextInputStateCfg"},normalFocused:{$type:"TextInputStateCfg"},mandatory:{$type:"TextInputStateCfg"},mandatoryFocused:{$type:"TextInputStateCfg"},normalError:{$type:"TextInputStateCfg"},normalErrorFocused:{$type:"TextInputStateCfg"},mandatoryError:{$type:"TextInputStateCfg"},mandatoryErrorFocused:{$type:"TextInputStateCfg"},disabled:{$type:"TextInputStateCfg"
},readOnly:{$type:"TextInputStateCfg"},prefill:{$type:"TextInputStateCfg"}}},simpleHTML:{$type:"json:Boolean",$description:'true when the widget has to have a basic markup as close as possible to standard HTML. As a consequence, a frame of type "SimpleHTML" will be used, which basically means that no further frame markup will be added.',$default:!1},frame:{$type:"Frame"},iconsLeft:{$type:"IconsLeft"},iconsRight:{$type:"IconsRight"},label:{$type:"Object",$description:"",$properties:{fontWeight:{$type:"json:String"
,$description:"",$default:"normal"}}},helpText:{$type:"Object",$description:"",$properties:{color:{$type:"Color"},italics:{$type:"json:Boolean",$description:""}}},innerPaddingTop:{$type:"Pixels",$default:0},innerPaddingRight:{$type:"Pixels",$default:0},innerPaddingBottom:{$type:"Pixels",$default:0},innerPaddingLeft:{$type:"Pixels",$default:0}}},TextInputStateCfg:{$type:"StateWithFrameWithIcons",$description:"",$properties:{color:{$type:"Color",$default:"#000"}}},DropDownTextInputCfg:{$type:"TextInputCfg",$description
:"",$properties:{offsetTop:{$type:"Pixels"}}},AutoCompleteCfg:{$type:"DropDownTextInputCfg",$description:"",$properties:{listSclass:{$type:"json:String",$description:"sclass of the List to use inside the widget. It must be defined in the skin.",$default:"dropdown"}}},TabPanelCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"StateWithFrame"}}},frame:{$type:"Frame"}}},TabCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{
normal:{$type:"StateWithFrame"},msover:{$type:"StateWithFrame"},selected:{$type:"StateWithFrame"},disabled:{$type:"StateWithFrame"},normalFocused:{$type:"StateWithFrame"},msoverFocused:{$type:"StateWithFrame"},selectedFocused:{$type:"StateWithFrame"}}},frame:{$type:"Frame"}}},SimpleFrameCfg:{$type:"Object",$description:"Used for widgets which have a basic frame around them. Frame properties are then specified state-wise.",$properties:{sprType:{$type:"json:Integer",$description:"Deprecated, please use frameType instead. The value corresponding to this type of frame is 6."
