...
:!1},listTemplate:{$type:"json:PackageName",$description:"Template to use to display the list.",$default:"aria.widgets.form.templates.TemplateMultiSelect"},listSclass:{$type:"json:String",$description:"sclass of the list used in the dropdown. The default value for this property is taken from the skin."},items:{$type:"ListCfg.items",$description:"List of options on a MultiSelect"},numberOfColumns:{$type:"FormListCfg:numberOfColumns",$description:"Number of Columns used in the template"},numberOfRows:{$type:"FormListCfg:numberOfRows"
,$description:"Number of Rows used in the template"},displayOptions:{$type:"FormListCfg:displayOptions",$description:"Display options that are not interpreted by the list controller."}}},DatePickerCfg:{$type:"DropDownTextInputCfg",$description:"Configuration of a DatePicker",$properties:{pattern:{$type:"environmentBase:FormatTypes",$description:"Date pattern used to propose a best value for the date entry in the date picker field."},inputPattern:{$type:"environmentBase:inputFormatTypes",$description:"Date pattern used to match user input and convert it in a Javascript valid date."
},minValue:{$type:"json:Date",$description:"Minimum date for the value property."},maxValue:{$type:"json:Date",$description:"Maximum date for the value property."},referenceDate:{$type:"json:Date",$description:"Reference date from which value can be calculated."},calendarTemplate:{$type:"json:PackageName",$description:"Template to use to display the calendar."},calendarLabel:{$type:"json:String",$description:"Label to be displayed inside the calendar when the DatePicker is open."},calendarDisplayUnit:{$type:"json:Enum"
,$description:"Minimum time unit which must be displayed entirely in the calendar. May be either month (M) or week (W). The default template currently only supports month (M).",$enumValues:["M","W"]},calendarNumberOfUnits:{$type:"json:Integer",$description:"Number of display units to show at the same time in the calendar."},calendarFirstDayOfWeek:{$type:"json:Integer",$description:"First day of the week for the display of the calendar. 0 = Sunday, ... 6 = Saturday. The null value means that it is set according to the regional settings."
,$minValue:0,$maxValue:6},calendarMonthLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each month in the calendar."},calendarDayOfWeekLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each day of the week in the calendar."},calendarDateLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each date in the calendar."},calendarCompleteDateLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying complete dates in the calendar."
},calendarShowWeekNumbers:{$type:"json:Boolean",$description:"Specifies whether week numbers should be displayed."},calendarShowShortcuts:{$type:"json:Boolean",$description:"Specifies if today and selected day shortcuts should be displayed"},calendarRestrainedNavigation:{$type:"json:Boolean",$description:"Specifies if today and selected day shortcuts should be displayed"},calendarSclass:{$type:"json:String",$description:"sclass of the calendar used in the dropdown. The default value for this property is taken from the skin."
},iconTooltip:{$type:"json:String",$description:"Tooltip label for the datepicker icon",$default:"Open the Calendar"},bind:{$type:"TextInputCfg.bind",$properties:{referenceDate:{$type:"common:BindingRef"}}}}},SelectBoxCfg:{$type:"DropDownTextInputCfg",$description:"Configuration of a SelectBox",$properties:{listTemplate:{$type:"json:PackageName",$description:"Template to use to display the list."},listSclass:{$type:"json:String",$description:"sclass of the list used in the dropdown. The default value for this property is taken from the skin."
},options:{$type:"json:Array",$description:"List of the possible values that have to be proposed to the user",$contentType:{$type:"ListItemCfg"},$default:[]},bind:{$type:"TextInputCfg.bind",$properties:{options:{$type:"common:BindingRef"}}}}},SelectCfg:{$type:"DropDownInputCfg",$description:"Configuration of a Select",$properties:{tabIndex:{$type:"WidgetCfg.tabIndex",$default:0},listTemplate:{$type:"json:PackageName",$description:"Template used for displaying the list."},listSclass:{$type:"json:String",$description
:"sclass of the list used in the dropdown. The default value for this property is taken from the skin."},options:{$type:"json:Array",$description:"List of the possible values displayed to the user",$contentType:{$type:"ListItemCfg"},$default:[]},onchange:{$type:"common:Callback",$description:"Function to be called when the state of the widget changes."},bind:{$type:"InputCfg.bind",$properties:{options:{$type:"common:BindingRef"}}}}},AutoCompleteCfg:{$type:"DropDownTextInputCfg",$description:"Configuration of an AutoComplete"
,$properties:{autoFill:{$type:"json:Boolean",$description:"Autofill the autocomplete textfield on navigation in the suggestions",$default:!0},freeText:{$type:"json:Boolean",$description:"Specifies if the user can enter its own text",$default:!0},suggestionsTemplate:{$type:"json:PackageName",$description:"Template to use to display the list."},resourcesHandler:{$type:"json:MultiTypes",$description:"",$contentTypes:[{$type:"json:PackageName",$description:"Classpath of the resources handler"},{$type:"json:ObjectRef"
,$description:"Instance of a resources handler"}],$mandatory:!0},preselect:{$type:"json:String",$description:"strict: for strict highlighting (exact match only), always: for selecting the first item everytime, none: for no highlighting",$default:"strict"},expandButton:{$type:"json:Boolean",$description:"Specifies if the button to get all the suggestions is displayed. Note that the getAllSuggestions method must be implemented on the resources handler for this feature to work (which is not the case for the default Air and Cities resources handlers)."
,$default:!1},popupMaxHeight:{$type:"json:Integer",$description:"Maximum height of the dropdown."},listSclass:{$type:"json:String",$description:"sclass of the list used in the dropdown. The default value for this property is taken from the skin."}}},ActionWidgetCfg:{$type:"WidgetCfg",$description:"The base configuration for the button widget",$properties:{label:{$type:"json:String",$description:"Text to put inside the label in the button",$default:""},onclick:{$type:"common:Callback",$description:"Function to be called when the user clicks on the button."
}}},ButtonCfg:{$type:"ActionWidgetCfg",$description:"The base configuration for the button widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{disabled:{$type:"common:BindingRef"}}},height:{$type:"json:Integer",$description:"The height of the button",$default:-1},disabled:{$type:"json:Boolean",$description:"A boolean whether the button is disabled or not",$default:!1},selected:{$type:"json:Boolean",$description:"DEPRECATED: A boolean whether the button is selected or not",$default:!1},tabIndex:{$type
:"WidgetCfg.tabIndex",$default:0}}},TextCfg:{$type:"WidgetCfg",$description:"The base configuration for the Text widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{text:{$type:"common:BindingRef"}}},text:{$type:"json:String",$description:"The text to be displayed",$default:""},activateEllipsis:{$type:"json:Boolean",$description:"DEPRECATED. Ellipsis is now automatically activated if you specify a non-empty ellipsis parameter.",$default:!1},ellipsis:{$type:"json:String",$description:"The string to be used as ellipsis"
},ellipsisLocation:{$type:"json:Enum",$enumValues:["left","right"],$description:"Which side will the ellipsis be, left or right",$default:"right"}}},IconButtonCfg:{$type:"ButtonCfg",$description:"The base configuration for the icon button widget",$properties:{icon:{$type:"json:String",$description:"The name of the sprite and the icon that is to be used in the form sprite:icon",$default:null}}},LinkCfg:{$type:"ActionWidgetCfg",$description:"The base configuration for the link widget",$properties:{color:{$type
:"json:String",$description:"The color of the text for the link"}}},SpriteCfg:{$type:"json:Object",$description:"Configuration needed when registering a new icon library",$properties:{name:{$type:"json:String",$description:"Name used to identify the icon lib that is being declared",$default:null},cssClass:{$type:"json:String",$description:"A css class that provides the sprite - either this or the spriteURL is needed",$default:""},spriteURL:{$type:"json:String",$description:"A URL to the sprite",$default:null
},spriteSpacing:{$type:"json:Integer",$description:"The number of pixels between each icon in the sprite - constant for all icons in this sprite",$default:0},iconWidth:{$type:"json:Integer",$description:"The width of each icon in the sprite in pixels - constant across all icons in this sprite",$default:-1},iconHeight:{$type:"json:Integer",$description:"The height of each icon in the sprite in pixels - constant across all icons in this sprite",$default:-1},biDimensional:{$type:"json:Boolean",$description:"This indicates whether the images are all in 1 line if false or in rows and columns if true"
,$default:!1},direction:{$type:"json:String",$description:"This can take two values x or y. It is used if the sprite is 1-dimensional, it corresponds to whether the icons are side-by-side (x), or one on top of another (y)",$default:"x"},content:{$type:"json:Map",$description:"This is the object that names each icon and gives a position",$contentType:{$type:"json:MultiTypes",$description:"",$contentTypes:[{$type:"json:Integer",$description:"A position in the sprite"},{$type:"json:String",$description:"A 2D position in the form x_y"
}]}}}},IconCfg:{$type:"WidgetCfg",$description:"Configuaration needed to use an icon in a template",$properties:{icon:{$type:"json:String",$description:"The name of the sprite and the icon that is to be used in the form sprite:icon",$default:null}}},DivCfg:{$type:"ResizableWidgetCfg",$description:"The base configuration for the div widget",$properties:{cssClass:{$type:"json:String",$description:"A string to be used to inject a Class into the main content area",$default:""}}},TemplateCfg:{$type:"ResizableWidgetCfg"
,$description:"The configuration for the template widget, to display sub-templates.",$properties:{printOptions:{$type:"WidgetCfg.printOptions",$default:"adaptXY"},defaultTemplate:{$type:"json:PackageName",$description:"Classpath of the template to be displayed when no customization has been done.",$mandatory:!0},data:{$type:"json:ObjectRef",$description:"JSON object to be made accessible in the sub-template as this.data. By default, use the parent template data, unless moduleCtrl is specified, in which case the data model of that module controller is used."
,$mandatory:!1},moduleCtrl:{$type:"templates:ModuleCtrl",$description:"Module controller to be used with the sub-template. By default, use the parent template module controller, unless data is specified and is the data model of one of the sub-modules of the parent template module controller, in which case that sub-module is used.",$mandatory:!1},args:{$type:"json:Array",$description:"Parameters to pass to the main macro in the sub-template.",$contentType:{$type:"json:MultiTypes",$description:"Any parameter to be passed to the main macro in the sub-template."
},$default:[]},baseTabIndex:{$type:"json:Integer",$description:"The base tab index that will be added to all tab indexes in the template",$default:0}}},TooltipCfg:{$type:"ResizableWidgetCfg",$description:"",$properties:{id:{$type:"WidgetCfg.id",$mandatory:!0},macro:{$type:"templates:MacroCfg",$description:"Macro to call to get the tooltip content. The Tooltip widget can either be used as a container, in which case this property must not be specified and the content of the tooltip is the content of the widget, or be used as a simple widget with no content, in which case this property must specify which macro to call to get the content of the tooltip."
,$mandatory:!1},sclass:{$type:"WidgetCfg.sclass",$default:"tooltip"},showOnlyOnMouseStill:{$type:"json:Boolean",$description:"",$default:!0},showDelay:{$type:"json:Integer",$description:"Delay before the tooltip is shown.",$default:100},closeOnMouseClick:{$type:"json:Boolean",$description:"Close the tooltip when the user clicks outside of the tooltip",$default:!0},closeOnMouseOut:{$type:"json:Boolean",$description:"Close the tooltip when the user leaves the tooltip, after a delay, set in closeOnMouseOutDelay"
,$default:!0},closeOnMouseOutDelay:{$type:"json:Integer",$description:"Delay before closing the tooltip when the user leaves the tooltip",$default:100},closeOnMouseScroll:{$type:"json:Boolean",$description:"Close the tooltip when the user scrolls outside of the popup",$default:!0}}},ErrorListCfg:{$type:"ResizableWidgetCfg",$description:"Configuration for the ErrorList widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{messages:{$type:"common:BindingRef"}}},defaultTemplate:{$type:"json:String",$description
:"Template used to display the messages list.",$default:"aria.widgets.errorlist.ErrorListTemplate"},messages:{$type:"json:ObjectRef",$description:"Messages list (of type aria.validators.CfgBeans.MessagesList) to be displayed in the widget.",$default:[]},displayCodes:{$type:"json:Boolean",$description:"True if message codes should be displayed along with localized messages.",$default:!0},title:{$type:"json:String",$description:"Title to be displayed in the widget.",$default:""},filterTypes:{$type:"json:Array"
,$description:"If not null, specifies the types of messages which should be displayed in the widget. It must match the type property in aria.utils.validators.CfgBeans.Message.",$default:null,$contentType:{$type:"json:String",$description:"Type of message.",$mandatory:!0},$sample:["F","E"]},block:{$type:"ResizableWidgetCfg.block",$default:!0}}},CalendarCfg:{$type:"ResizableWidgetCfg",$description:"Configuration for the Calendar widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{value:{$type:"common:BindingRef"
},startDate:{$type:"common:BindingRef"}}},tabIndex:{$type:"WidgetCfg.tabIndex",$default:0},label:{$type:"json:String",$description:"Label text to associate to the calendar."},showWeekNumbers:{$type:"json:Boolean",$description:"Specifies whether week numbers should be displayed.",$default:!0},defaultTemplate:{$type:"json:PackageName",$description:"Template to use to display the calendar."},onclick:{$type:"common:Callback",$description:"Function to be called when the user clicks on a date in the calendar, before it is actually selected."
},onchange:{$type:"common:Callback",$description:"Function to be called when the selected date in the calendar changes because of user action (click or keyboard selection)."},value:{$type:"json:Date",$description:"Date currently selected in the calendar."},minValue:{$type:"json:Date",$description:"Minimum date for the value property."},maxValue:{$type:"json:Date",$description:"Maximum date for the value property."},displayUnit:{$type:"json:Enum",$description:"Minimum time unit which must be displayed entirely in the calendar. May be either month (M) or week (W). The default template currently only supports month (M)."
,$enumValues:["M","W"]},numberOfUnits:{$type:"json:Integer",$description:"Number of display units to show at the same time.",$default:3},startDate:{$type:"json:Date",$description:"Approximate first date in the currently displayed calendar. However, as the calendar may have a display with whole weeks or whole months, dates before this date may also appear."},firstDayOfWeek:{$type:"json:Integer",$description:"First day of the week. 0 = Sunday, ... 6 = Saturday. The null value means that it is set according to the regional settings."
,$minValue:0,$maxValue:6},monthLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each month."},dayOfWeekLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each day of the week."},dateLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each date in the calendar."},completeDateLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying complete dates."},showShortcuts:{$type:"json:Boolean"
,$description:"Specifies if today and selected day shortcuts should be displayed",$default:!0},restrainedNavigation:{$type:"json:Boolean",$description:"Specifies if today and selected day shortcuts should be displayed",$default:!0}}},ListCfg:{$type:"ResizableWidgetCfg",$description:"Configuration for the List widget. ",$properties:{tabIndex:{$type:"WidgetCfg.tabIndex",$default:0},defaultTemplate:{$type:"json:PackageName",$description:"Template to use to display the list.",$default:"aria.widgets.form.list.templates.ListTemplate"
},preselect:{$type:"json:String",$description:"strict: for strict highlighting (exact match only), always: for selecting the first item everytime, none: for no highlighting",$default:"strict"},items:{$type:"json:MultiTypes",$description:"The possible choices in the list.",$contentTypes:[{$type:"json:Array",$description:"value/label pairs",$contentType:{$type:"json:Object",$description:"Label/value pairs",$properties:{label:{$type:"json:String",$description:"The string to show"},value:{$type:"json:MultiTypes"
,$description:"The value of the item"}}}},{$type:"json:Object",$description:"Container reference with Label/value property names",$properties:{container:{$type:"json:Object",$description:"The container to take the items from",$default:{}},labelProperty:{$type:"json:String",$description:"The name of the property containing the label",$default:""},valueProperty:{$type:"json:String",$description:"The name of the property containing the value",$default:""}}}]},selectedValues:{$type:"json:Array",$description:"Values of currently selected items."
,$default:[],$contentType:{$type:"json:MultiTypes",$description:"Same type as the key for the items"}},selectedIndex:{$type:"json:Integer",$description:"Index of the selected element in the list, if only one is or should be selected. -1 means no element is selected. A null value means several elements are selected."},maxOptions:{$type:"json:Integer",$description:"Maximum number of options that can be selected at the same time. It is only taken into account if multipleSelect is true. A null value means there is no maximum."
,$minValue:1},multipleSelect:{$type:"json:Boolean",$description:"This must be set to true if several items can be selected at the same time.",$default:!1},activateSort:{$type:"json:Boolean",$description:"Allows the developer to specify if the list of options should be sorted by labels",$default:!1},disabled:{$type:"json:Boolean",$description:"true if input is disabled",$default:!1},onclick:{$type:"common:Callback",$description:"Function to be called when the user clicks on an element in the list, before it is actually selected."
},onchange:{$type:"common:Callback",$description:"Function to be called when the state of the widget changes due to user action (click or keyboard)."},onkeyevent:{$type:"common:Callback",$description:"Function to be called when a key event occurs."},onmouseover:{$type:"common:Callback",$description:"Function to be called when the user moves the mouse over an item in the list."},bind:{$type:"WidgetCfg.bind",$properties:{selectedValues:{$type:"common:BindingRef"},selectedIndex:{$type:"common:BindingRef"},items
:{$type:"common:BindingRef"},disabled:{$type:"common:BindingRef"},multipleSelect:{$type:"common:BindingRef"},maxOptions:{$type:"common:BindingRef"}}},displayOptions:{$type:"FormListCfg:displayOptions",$description:"This is a configuration object that is used by the multi-select"},numberOfColumns:{$type:"FormListCfg:numberOfColumns",$description:"Number of Columns used by the multi-select List. This property can be applied only with multi-select List"},numberOfRows:{$type:"FormListCfg:numberOfRows",$description
:"Number of Rows used by the multi-select List. This property can be applied only with multi-select List"},onclose:{$type:"common:Callback",$description:"Function to be called when the user triggers the close event of the List"}}},DialogCfg:{$type:"DivCfg",$description:"The base configuration for the Dialog widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{visible:{$type:"common:BindingRef"},contentMacro:{$type:"common:BindingRef"},title:{$type:"common:BindingRef"},xpos:{$type:"common:BindingRef"
},ypos:{$type:"common:BindingRef"},center:{$type:"common:BindingRef"}}},title:{$type:"json:String",$description:"The title of the dialog which will be displayed in the header",$default:""},visible:{$type:"json:Boolean",$description:"A boolean whether the dialog is visible",$default:!1},contentMacro:{$type:"templates:MacroCfg",$description:"The macro that will be used as dialog content, Browser will freeze if it does not find this property  as part of widget or bindable property"},icon:{$type:"json:String",$description
:"Icon to use in the title bar (same as the icon property of the Icon widget)"},modal:{$type:"json:Boolean",$description:"Whether the dialog box is modal. If it is modal, a mask is shown behind the dialog box so that mouse and keyboard interraction with elements behind the dialog box is not possible.",$default:!1},closable:{$type:"json:Boolean",$description:"Whether the dialog has a close button in its title bar.",$default:!0},closeOnMouseClick:{$type:"json:Boolean",$description:"Close the dialog when the user clicks outside of it"
,$default:!1},center:{$type:"json:Boolean",$description:"If true, the dialog is always centered in the browser window. Takes priority over xpos and ypos. However, if the dialog box is movable and the user manually moves it, the centered behavior will be switched off.",$default:!0},xpos:{$type:"json:Integer",$description:"x position of the top left corner of the dialog box.",$default:0},ypos:{$type:"json:Integer",$description:"y position of the top left corner of the dialog box.",$default:0},movable:{$type:"json:Boolean"
,$description:"If true, the dialog can be moved. The default is read from the application environment."},resizable:{$type:"json:Boolean",$description:"If true, the dialog can be resizable. The default is false.",$default:!1},movableProxy:{$type:"dragDrop:ProxyCfg",$description:"Specifies the type of proxy dor the dialog motion. The default is read from the application environment."},onOpen:{$type:"common:Callback",$description:"Callback called when the dialog is open, right after it is displayed. Can be used to set the focus on the right element in the dialog."
},onCloseClick:{$type:"common:Callback",$description:"Callback called when the close button is clicked. If not specified, the dialog will simply be closed when clicking on the close button. If specified, the dialog will only be closed if the callback either sets the visible property of the Dialog to false (through bindings) or sets to false the cancelDefault property of its first parameter. This allows the developper to give the same callback method to both the onCloseClick property of the dialog and the onclick property of a close button inside the dialog."
...
:"ResizableWidgetCfg.width",$mandatory:!0},adapt:{$type:"json:Enum",$enumValues:["size1","size2","both"],$description:"Size adapted when the size of the splitter is different than the sum of size1 and size2",$default:"both"},orientation:{$type:"json:Enum",$enumValues:["horizontal","vertical"],$description:"Defines the position horizontal or vertical for the splitter ",$default:"horizontal"},border:{$type:"json:Boolean",$description:"This determines whether a border should be shown around the splitter",$default
:!0},bind:{$type:"WidgetCfg.bind",$properties:{size1:{$type:"common:BindingRef"},size2:{$type:"common:BindingRef"}}}}}}});
//*******************
...
.getSkinObject("Dialog",e.sclass),this._popup=null,this._hasMarkup=!1,this._closeDelegateId=null,this._draggable=null;var n=e.handles||"n-resize,s-resize,e-resize,w-resize,ne-resize,nw-resize,se-resize,sw-resize";this._handlesArr=n.split(","),this._resizable={}},$destructor:function(){this.close(),this.$Container.$destructor.call(this)},$statics:{MISSING_CONTENT_MACRO:"Missing contentMacro in Dialog configuration."},$prototype:{_onViewportResized:function(e){var t=this._domElt;t.style.width="",t.style.height=""
;var n=aria.utils.Dom._getViewportSize(),r=aria.utils.Math;this._div.updateSize({height:this._cfg.height,maxHeight:r.min(this._cfg.maxHeight,n.height),width:this._cfg.width,maxWidth:r.min(this._cfg.maxWidth,n.width)}),this._updateContainerSize()},_checkCfgConsistency:function(e){!("contentMacro"in e)&&!("bind"in e&&"contentMacro"in e.bind)&&this.$logError(this.MISSING_CONTENT_MACRO);var t=aria.widgets.environment.WidgetSettings.getWidgetSettings().dialog;"movable"in e||(e.movable=t.movable),"movableProxy"in 
e||(e.movableProxy=t.movableProxy)},_widgetMarkupBegin:function(e){var t=this._cfg;this._skipContent=e.sectionState==e.SECTION_KEEP||!t.visible,e.beginSection({id:"__dialog_"+this._domId});if(this._skipContent)return;var n=aria.utils.Dom._getViewportSize(),r=aria.utils.Math,i=r.min(this._cfg.maxHeight,n.height),s=r.min(this._cfg.maxWidth,n.width);this._div=new aria.widgets.container.Div({sclass:this._skinObj.divsclass,margins:"0 0 0 0",block:!0,cssClass:this._context.getCSSClassNames(!0)+" "+this._cfg.cssClass
,height:this._cfg.height,minHeight:this._cfg.minHeight,maxHeight:i,width:this._cfg.width,minWidth:this._cfg.minWidth,maxWidth:s,scrollBarX:this._cfg.scrollBarX,scrollBarY:this._cfg.scrollBarY},this._context,this._lineNumber),e.registerBehavior(this._div),this._div.writeMarkupBegin(e),e.beginSection({id:"__dialogContent_"+this._domId,keyMap:[{key:"ESCAPE",callback:{fn:this.actionClose,scope:this}}]})},_widgetMarkupEnd:function(e){var t=this._cfg;if(!this._skipContent){e.endSection(),this._div.writeMarkupEnd(e
);if(t.resizable&&this._handlesArr){var n=this._handlesArr;for(var r=0,i=n.length;r<i;r++)e.write(['<span class="xDialog_resizable xDialog_'+n[r]+'">',"</span>"].join(""))}e.write(['<div class="xDialog_titleBar xDialog_',t.sclass,'_titleBar">'].join(""));if(t.icon){e.write(['<span class="xDialog_icon xDialog_',t.sclass,'_icon">'].join(""));var s=new aria.widgets.Icon({icon:t.icon},this._context,this._lineNumber);e.registerBehavior(s),s.writeMarkup(e),e.write("</span>")}e.write(['<span class="xDialog_title xDialog_'
,t.sclass,'_title">',aria.utils.String.escapeHTML(t.title),"</span>"].join(""));if(t.closable){var o=aria.utils.Delegate;this._closeDelegateId=o.add({fn:this._onCloseBtnEvent,scope:this}),e.write(['<span class="xDialog_close xDialog_',t.sclass,'_close" '+o.getMarkup(this._closeDelegateId)+">"].join(""));var u=new aria.widgets.Icon({icon:this._skinObj.closeIcon},this._context,this._lineNumber);e.registerBehavior(u),u.writeMarkup(e),e.write("</span>")}e.write("</div>")}e.endSection()},_widgetMarkup:function(e)
{this._widgetMarkupBegin(e),this._widgetMarkupEnd(e)},_writerCallback:function(e){this._widgetMarkupBegin(e),this._cfg.contentMacro&&e.callMacro(this._cfg.contentMacro),this._widgetMarkupEnd(e)},initWidget:function(){this.$Container.initWidget.apply(this,arguments),this._cfgOk&&this._checkCfgConsistency(this._cfg),this._init()},_init:function(){this.getProperty("visible")&&this._cfgOk&&this.open()},_onBoundPropertyChange:function(e,t,n){if(e==="visible")this._cfg.visible=t,t?this.open():this.close();else if(
e==="title")this._cfg.title=t,this._titleDomElt&&(this._titleDomElt.innerHTML=t);else if(e==="contentMacro"){this._cfg.contentMacro=t;if(this._popup)if(!this._popup.isOpen)this.open();else{var r={outputSection:"__dialogContent_"+this._domId,macro:t};this._context.$refresh(r)}}else e==="xpos"||e==="ypos"?(this._cfg[e]=t,this.setProperty("center",!1),this.updatePosition()):e==="center"?(this._cfg.center=t,this.updatePosition()):this.$Container._onBoundPropertyChange.apply(this,arguments)},_onCloseBtnEvent:function(
e){e.type=="click"&&this.actionClose()},actionClose:function(){var e=this._cfg.onCloseClick,t=!1;if(e){var n={cancelDefault:!0};this.evalCallback(e,n),t=n.cancelDefault}t||this.changeProperty("visible",!1)},open:function(){var e=this._cfg,t={filterSection:"__dialog_"+this._domId,writerCallback:{fn:this._writerCallback,scope:this}},n=this._context.getRefreshedSection(t),r=new aria.popups.Popup;this._popup=r,r.$on({onAfterOpen:this._onAfterPopupOpen,scope:this}),e.closeOnMouseClick&&r.$on({onMouseClickClose:this
._onMouseClickClose,scope:this});if(this._cfg.modal){var i=aria.templates.NavigationManager;i.addGlobalKeyMap({key:"ESCAPE",modal:!0,callback:{fn:this.actionClose,scope:this}}),i.setModalBehaviour(!0)}r.open({section:n,keepSection:!0,absolutePosition:{left:e.xpos,top:e.ypos},center:e.center,modal:e.modal,maskCssClass:"xDialogMask",closeOnMouseClick:e.closeOnMouseClick,closeOnMouseScroll:!1,parentDialog:this}),aria.templates.Layout.$on({viewportResized:this._onViewportResized,scope:this})},_onAfterPopupOpen:function(
){var e=this._cfg,t=aria.utils.Dom.getDomElementChild;this._domElt=this._popup.domElement,this._titleBarDomElt=t(this._domElt,0,!0),this._titleDomElt=t(this._titleBarDomElt,e.icon?1:0),this._calculatePosition(),e.modal&&aria.templates.NavigationManager.focusFirst(this._domElt),this.evalCallback(e.onOpen),e.movable&&Aria.load({classes:["aria.utils.dragdrop.Drag"],oncomplete:{fn:this._createDraggable,scope:this}}),e.resizable&&Aria.load({classes:["aria.utils.resize.Resize"],oncomplete:{fn:this._createResize,scope
:this}})},_onMouseClickClose:function(){this.actionClose()},close:function(){var e=this._cfg;if(this._popup){e.movable&&this._destroyDraggable(),e.resizable&&this._destroyResizable(),this._domElt=null,this._titleBarDomElt=null,this._titleDomElt=null,this._closeDelegateId&&aria.utils.Delegate.remove(this._closeDelegateId),this._popup.close(),this._popup.$dispose(),this._popup=null;if(e.modal){var t=aria.templates.NavigationManager;t.removeGlobalKeyMap({key:"ESCAPE",modal:!0,callback:{fn:this.actionClose,scope
:this}}),t.setModalBehaviour(!1)}aria.templates.Layout.$removeListeners({viewportResized:this._onViewportResized,scope:this})}},_updateContainerSize:function(){this.$Container._updateContainerSize.call(this),this.updatePosition()},updatePosition:function(){this._popup&&this._popup.isOpen&&(this._popup.moveTo({center:this._cfg.center,absolutePosition:{left:this._cfg.xpos,top:this._cfg.ypos,height:this._cfg.height,width:this._cfg.width}}),this._calculatePosition())},_calculatePosition:function(){var e=aria.utils
.Dom.calculatePosition(this._domElt);this.setProperty("xpos",e.left),this.setProperty("ypos",e.top)},_calculateSize:function(){var e=aria.utils.Dom.getGeometry(this._domElt);this.setProperty("height",e.height),this.setProperty("width",e.width)},_createDraggable:function(){this._draggable=new aria.utils.dragdrop.Drag(this._domElt,{handle:this._titleBarDomElt,cursor:"move",proxy:this._cfg.movableProxy,constrainTo:aria.utils.Dom.VIEWPORT}),this._draggable.$on({dragstart:{fn:this._onDragStart,scope:this},move:{fn
:this._onDragMove,scope:this},dragend:{fn:this._onDragEnd,scope:this}})},_createResize:function(){if(this._handlesArr){var e=this._handlesArr,t=0,n=this._domElt,r=aria.utils.Dom.getDomElementChild;for(var i=0,s=e.length;i<s;i++){var o=r(n,++t,!1),u=null,a;a=e[i];if(a=="n-resize"||a=="s-resize")u="y";if(a=="w-resize"||a=="e-resize")u="x";this._resizable[a]=new aria.utils.resize.Resize(this._domElt,{handle:o,cursor:a,axis:u}),this._resizable[a].$on({beforeresize:{fn:this._onResizeStart,scope:this},resize:{fn:this
._onResizing,scope:this},resizeend:{fn:this._onResizeEnd,scope:this}})}}},_onDragStart:function(){this.evalCallback(this._cfg.ondragstart)},_onDragMove:function(){!this._cfg.movableProxy&&this._popup&&this._popup.refreshProcessingIndicators()},_onDragEnd:function(){this._popup&&this._popup.refreshProcessingIndicators(),this.setProperty("center",!1),this._calculatePosition(),this.updatePosition(),this.evalCallback(this._cfg.ondragend)},_onResizeStart:function(){this.evalCallback(this._cfg.beforeresize)},_onResizing
:function(){this._popup&&this._popup.refreshProcessingIndicators()},_onResizeEnd:function(){this._calculatePosition(),this._calculateSize(),this.setProperty("center",!1),this._popup&&(this.close(),this.open(),this._popup.refreshProcessingIndicators()),this.evalCallback(this._cfg.resizeend)},_destroyDraggable:function(){this._draggable.$removeListeners({dragstart:{fn:this._onDragStart,scope:this},move:{fn:this._onDragMove,scope:this},dragend:{fn:this._onDragEnd,scope:this}}),this._draggable.$dispose(),this._draggable=
null},_destroyResizable:function(){var e=this._handlesArr;for(var t=0,n=e.length;t<n;t++){var r=e[t];this._resizable[r].$dispose(),this._resizable[r]=null}}}});
//*******************
